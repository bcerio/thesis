...
\title{Achieving Fusion: Evidence of Higgs Boson Production via Vector
Boson Fusion}
...
\newcommand{\POWHEGns}{P\textsc{owheg}}
\newcommand{\PYTHIAns}{P\textsc{ythia}}
\newcommand{\Ztautaunody}{\ensuremath{Z\rightarrow{\tau\tau}}\xspace}
\newcommand{\ctten}{\textsc{CT10}\xspace}
\newcommand{\nnpdf}{\textsc{NNPDF}\xspace}
\newcommand{\textapprox}{\raisebox{0.5ex}{\texttildelow}}
\newcommand{\ww}{\ensuremath{WW}\xspace}
\newcommand{\wwtwoj}{$WW+2\textrm{j}$\xspace}
\newcommand{\cteqsixl}{\textsc{CTEQ6L1}\xspace}
...
\newcommand{\zzero}{\ensuremath{z_0}\xspace}
\newcommand{\antikt}{\ensuremath{\textrm{anti-}k_{\textrm{T}}}\xspace}
\newcommand{\fastjet}{F\textsc{astjet}}
%\newcommand{\etmiss}{\ensuremath{E_{\mathrm{T}}^{\rm miss}}\xspace}
\newcommand{\fakefact}{\ensuremath{f_{\textrm{factor}}}\xspace}
\newcommand{\muprime}{\ensuremath{\mu^{\prime}}\xspace}
\newcommand{\hzz}{\ensuremath{H{\rightarrow\,}ZZ^{(\ast)}}\xspace}
\newcommand{\hgg}{\ensuremath{H{\rightarrow\,}\gamma\gamma}\xspace}
\newcommand{\note}[1]{{\color{red} (#1)}\xspace}
...
\newcommand{\calomet}{\ensuremath{E_{\mathrm{T}}^{\rm miss, CALO}}\xspace}
\newcommand{\calometrel}{\ensuremath{E_{\rm T,rel}^{\rm miss, CALO}}\xspace}
...
\newcommand{\vTptot}{\ensuremath{{\bf p}_{\rm T}^{\rm tot}}\xspace}
...
\newcommand{\ZDY}{\ensuremath{Z/\mathrm{DY}}\xspace}
...
\newcommand{\lepEtaCent}{\ensuremath{\eta_{\mathrm{lep}}} centrality\xspace}

% mu and npv
\newcommand{\nvtx}{\ensuremath{N_{\textrm{PV}}}\xspace}
\newcommand{\Mu}{$\mu$~}
