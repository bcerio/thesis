...
//=========  (Mon Jul  7 00:47:50 2014) by ROOT version5.34/18
   TCanvas *c = new TCanvas("c", "c",0,0,1000,600);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   c->SetHighLightColor(2);
   c->Range(-23.52941,-1.225051,123.5294,3.334519);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetLogy();
   ...
   mc_el_pt_1000_el_pt_1000->SetMaximum(798.7669);
   
   TH1F *mc_el_pt_1000_el_pt_1000_stack_1 = new TH1F("mc_el_pt_1000_el_pt_1000_stack_1","el_pt_1000",4,0,100);
   mc_el_pt_1000_el_pt_1000_stack_1->SetMinimum(0.3195068);
   mc_el_pt_1000_el_pt_1000_stack_1->SetMaximum(1278.027);
   ...
   mc_el_pt_1000_ttbarother_elmu_el_pt_1000->SetBinContent(2,8.331944);
   mc_el_pt_1000_ttbarother_elmu_el_pt_1000->SetBinContent(3,2.535879);
   mc_el_pt_1000_ttbarother_elmu_el_pt_1000->SetBinContent(4,2.275462);
   mc_el_pt_1000_ttbarother_elmu_el_pt_1000->SetBinError(2,2.886511);
   mc_el_pt_1000_ttbarother_elmu_el_pt_1000->SetBinError(3,1.592444);
   mc_el_pt_1000_ttbarother_elmu_el_pt_1000->SetBinError(4,1.508463);
   mc_el_pt_1000_ttbarother_elmu_el_pt_1000->SetEntries(471);
   ...
   mc_el_pt_1000_ttbarelmu_elmu_el_pt_1000->SetBinContent(2,781.7895);
   mc_el_pt_1000_ttbarelmu_elmu_el_pt_1000->SetBinContent(3,450.5513);
   mc_el_pt_1000_ttbarelmu_elmu_el_pt_1000->SetBinContent(4,385.7115);
   mc_el_pt_1000_ttbarelmu_elmu_el_pt_1000->SetBinError(2,27.9605);
   mc_el_pt_1000_ttbarelmu_elmu_el_pt_1000->SetBinError(3,21.22619);
   mc_el_pt_1000_ttbarelmu_elmu_el_pt_1000->SetBinError(4,19.63954);
   mc_el_pt_1000_ttbarelmu_elmu_el_pt_1000->SetEntries(56153);
   ...
   data_el_pt_1000_el_pt_1000->SetMaximum(798.7669);
   
   TH1F *data_el_pt_1000_el_pt_1000_stack_2 = new TH1F("data_el_pt_1000_el_pt_1000_stack_2","el_pt_1000",4,0,100);
   data_el_pt_1000_el_pt_1000_stack_2->SetMinimum(0.3195068);
   data_el_pt_1000_el_pt_1000_stack_2->SetMaximum(1278.027);
   ...
   data_el_pt_1000_AllData_elmu_el_pt_1000->SetBinContent(2,771);
   data_el_pt_1000_AllData_elmu_el_pt_1000->SetBinContent(3,423);
   data_el_pt_1000_AllData_elmu_el_pt_1000->SetBinContent(4,390);
   data_el_pt_1000_AllData_elmu_el_pt_1000->SetBinError(2,27.76689);
   data_el_pt_1000_AllData_elmu_el_pt_1000->SetBinError(3,20.56696);
   data_el_pt_1000_AllData_elmu_el_pt_1000->SetBinError(4,19.74842);
   data_el_pt_1000_AllData_elmu_el_pt_1000->SetEntries(1588);
