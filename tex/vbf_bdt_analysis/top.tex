...
\caption[Cutflow in top CR.]{Event yields for \ttbar, single top,
non-top backgrounds, and data in the top control region, shown at each
cut stage starting with $\Nbjet = 1$. The corresponding top
normalization factor is shown in {\color{blue}blue}.}
